...
$api_instance = new nullx27\ESI\Api\RoutesApi();
...
try {
    $result = $api_instance->getRouteOriginDestination($destination, $origin, $avoid, $connections, $datasource, $flag, $userAgent, $xUserAgent);
    print_r($result);
} catch (Exception $e) {
