...
# **getWarsWarId**
> \nullx27\ESI\Models\GetWarsWarIdOk getWarsWarId($warId, $datasource)
...
> \nullx27\ESI\Models\GetWarsWarIdKillmails200Ok[] getWarsWarIdKillmails($warId, $page, $datasource)
