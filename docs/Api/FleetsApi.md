...
try {
    $result = $apiInstance->getCharactersCharacterIdFleet($characterId, $datasource, $token, $userAgent, $xUserAgent);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->getFleetsFleetId($fleetId, $datasource, $token, $userAgent, $xUserAgent);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->getFleetsFleetIdMembers($fleetId, $datasource, $language, $token, $userAgent, $xUserAgent);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->getFleetsFleetIdWings($fleetId, $datasource, $language, $token, $userAgent, $xUserAgent);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->postFleetsFleetIdWings($fleetId, $datasource, $token, $userAgent, $xUserAgent);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->postFleetsFleetIdWingsWingIdSquads($fleetId, $wingId, $datasource, $token, $userAgent, $xUserAgent);
    print_r($result);
} catch (Exception $e) {
