...
class PlanetaryInteractionApi
{
     ...
     */
    protected function getCharactersCharacterIdPlanetsRequest($characterId, $datasource = 'tranquility', $token = null, $userAgent = null, $xUserAgent = null)
    {
        ...
        if ($characterId < 1) {
            throw new \InvalidArgumentException('invalid value for "$characterId" when calling PlanetaryInteractionApi.getCharactersCharacterIdPlanets, must be bigger than or equal to 1.');
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCharactersCharacterIdPlanetsPlanetIdRequest($characterId, $planetId, $datasource = 'tranquility', $token = null, $userAgent = null, $xUserAgent = null)
    {
        // verify the required parameter 'characterId' is set
        if ($characterId === null) {
            throw new \InvalidArgumentException(
        ...
        if ($characterId < 1) {
            throw new \InvalidArgumentException('invalid value for "$characterId" when calling PlanetaryInteractionApi.getCharactersCharacterIdPlanetsPlanetId, must be bigger than or equal to 1.');
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCorporationsCorporationIdCustomsOfficesRequest($corporationId, $datasource = 'tranquility', $page = '1', $token = null, $userAgent = null, $xUserAgent = null)
    {
        ...
        if ($corporationId < 1) {
            throw new \InvalidArgumentException('invalid value for "$corporationId" when calling PlanetaryInteractionApi.getCorporationsCorporationIdCustomsOffices, must be bigger than or equal to 1.');
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getUniverseSchematicsSchematicIdRequest($schematicId, $datasource = 'tranquility', $userAgent = null, $xUserAgent = null)
    {
        ...
        if ($schematicId !== null) {
            $resourcePath = str_replace(
                '{' . 'schematic_id' . '}',
                ObjectSerializer::toPathValue($schematicId),
                $resourcePath
            );
        }
