...
class WarsApi
{
     ...
     * @return int[]
     */
    public function getWars($datasource = 'tranquility', $maxWarId = null, $userAgent = null, $xUserAgent = null)
    {
     ...
     */
    public function getWarsWithHttpInfo($datasource = 'tranquility', $maxWarId = null, $userAgent = null, $xUserAgent = null)
    {
        $returnType = 'int[]';
        $request = $this->getWarsRequest($datasource, $maxWarId, $userAgent, $xUserAgent);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWarsAsyncWithHttpInfo($datasource = 'tranquility', $maxWarId = null, $userAgent = null, $xUserAgent = null)
    {
        $returnType = 'int[]';
        $request = $this->getWarsRequest($datasource, $maxWarId, $userAgent, $xUserAgent);
     ...
     */
    protected function getWarsRequest($datasource = 'tranquility', $maxWarId = null, $userAgent = null, $xUserAgent = null)
    {
        ...
        // query params
        if ($maxWarId !== null) {
            $queryParams['max_war_id'] = ObjectSerializer::toQueryValue($maxWarId);
        }
        // query params
        if ($userAgent !== null) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getWarsWarIdRequest($warId, $datasource = 'tranquility', $userAgent = null, $xUserAgent = null)
    {
        // verify the required parameter 'warId' is set
        if ($warId === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $warId when calling getWarsWarId'
            );
        }
        ...
        if ($warId !== null) {
            $resourcePath = str_replace(
                '{' . 'war_id' . '}',
                ObjectSerializer::toPathValue($warId),
                $resourcePath
            );
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getWarsWarIdKillmailsRequest($warId, $datasource = 'tranquility', $page = '1', $userAgent = null, $xUserAgent = null)
    {
        // verify the required parameter 'warId' is set
        if ($warId === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $warId when calling getWarsWarIdKillmails'
            );
        }
