...
class StatusApi
{
     ...
     */
    public function getStatus($datasource = 'tranquility', $userAgent = null, $xUserAgent = null)
    {
        list($response) = $this->getStatusWithHttpInfo($datasource, $userAgent, $xUserAgent);
        return $response;
    }
     ...
     * @throws \nullx27\ESI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \nullx27\ESI\nullx27\ESI\Models\GetStatusOk, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStatusWithHttpInfo($datasource = 'tranquility', $userAgent = null, $xUserAgent = null)
    {
        $returnType = '\nullx27\ESI\nullx27\ESI\Models\GetStatusOk';
        $request = $this->getStatusRequest($datasource, $userAgent, $xUserAgent);
     ...
     */
    public function getStatusAsync($datasource = 'tranquility', $userAgent = null, $xUserAgent = null)
    {
        return $this->getStatusAsyncWithHttpInfo($datasource, $userAgent, $xUserAgent)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatusAsyncWithHttpInfo($datasource = 'tranquility', $userAgent = null, $xUserAgent = null)
    {
        $returnType = '\nullx27\ESI\nullx27\ESI\Models\GetStatusOk';
        $request = $this->getStatusRequest($datasource, $userAgent, $xUserAgent);
     ...
     */
    protected function getStatusRequest($datasource = 'tranquility', $userAgent = null, $xUserAgent = null)
    {
