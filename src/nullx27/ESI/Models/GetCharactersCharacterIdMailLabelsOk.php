...
class GetCharactersCharacterIdMailLabelsOk implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['totalUnreadCount']) && ($this->container['totalUnreadCount'] < 0)) {
            $invalidProperties[] = "invalid value for 'totalUnreadCount', must be bigger than or equal to 0.";
        }
    ...
    public function valid()
    {
        ...
        if ($this->container['totalUnreadCount'] < 0) {
            return false;
        }
        return true;
    }
    ...
    public function setTotalUnreadCount($totalUnreadCount)
    {
        ...
        if (!is_null($totalUnreadCount) && ($totalUnreadCount < 0)) {
            throw new \InvalidArgumentException('invalid value for $totalUnreadCount when calling GetCharactersCharacterIdMailLabelsOk., must be bigger than or equal to 0.');
        }
