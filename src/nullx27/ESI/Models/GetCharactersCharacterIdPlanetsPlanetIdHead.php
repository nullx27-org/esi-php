...
class GetCharactersCharacterIdPlanetsPlanetIdHead implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['headId'] === null) {
            $invalidProperties[] = "'headId' can't be null";
        }
        if (($this->container['headId'] > 9)) {
            $invalidProperties[] = "invalid value for 'headId', must be smaller than or equal to 9.";
        }

        if (($this->container['headId'] < 0)) {
            $invalidProperties[] = "invalid value for 'headId', must be bigger than or equal to 0.";
        }
