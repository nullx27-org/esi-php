...
class GetCorporationsCorporationIdFwStatsOk implements ModelInterface, ArrayAccess
{
     ...
     * Sets factionId
     *
     * @param int $factionId The faction the given corporation is enlisted to fight for. Will not be included if corporation is not enlisted in faction warfare
     *
     * @return $this
     */
     ...
     * Sets enlistedOn
     *
     * @param \DateTime $enlistedOn The enlistment date of the given corporation into faction warfare. Will not be included if corporation is not enlisted in faction warfare
     *
     * @return $this
     */
