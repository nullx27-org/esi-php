...
class StatusApi
{
     ...
     */
    public function getStatus($datasource = null, $userAgent = null, $xUserAgent = null)
    {
     ...
     */
    public function getStatusWithHttpInfo($datasource = null, $userAgent = null, $xUserAgent = null)
    {
        // parse inputs
        $resourcePath = "/status/";
        $httpBody = '';
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\nullx27\ESI\Models\GetStatusOk', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\nullx27\ESI\Models\GetStatusOk', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\nullx27\ESI\Models\GetStatusInternalServerError', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
