...
class LocationApi
{
     ...
     * @return bool
     */
    public function getCharactersCharacterIdOnline($characterId, $datasource = null, $token = null, $userAgent = null, $xUserAgent = null)
    {
     ...
     */
    public function getCharactersCharacterIdOnlineWithHttpInfo($characterId, $datasource = null, $token = null, $userAgent = null, $xUserAgent = null)
    {
        // verify the required parameter 'characterId' is set
        if ($characterId === null) {
            throw new \InvalidArgumentException('Missing the required parameter $characterId when calling getCharactersCharacterIdOnline');
        }
        // parse inputs
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    ...
                    break;
                case 403:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\nullx27\ESI\Models\GetCharactersCharacterIdOnlineForbidden', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\nullx27\ESI\Models\GetCharactersCharacterIdOnlineInternalServerError', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
