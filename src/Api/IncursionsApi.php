...
class IncursionsApi
{
     ...
     */
    public function getIncursions($datasource = null, $userAgent = null, $xUserAgent = null)
    {
     ...
     */
    public function getIncursionsWithHttpInfo($datasource = null, $userAgent = null, $xUserAgent = null)
    {
        // parse inputs
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\nullx27\ESI\Models\GetIncursions200Ok[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\nullx27\ESI\Models\GetIncursions200Ok[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\nullx27\ESI\Models\GetIncursionsInternalServerError', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
