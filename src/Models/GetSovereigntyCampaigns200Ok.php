...
class GetSovereigntyCampaigns200Ok implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'defenderScore' => 'float',
        'eventType' => 'string',
        'participants' => '\nullx27\ESI\Models\SovereigntycampaignsParticipants[]',
        'solarSystemId' => 'int',
        'startTime' => '\DateTime',
        'structureId' => 'int'
    );
    ...
    /**
     * Sets participants
     * @param \nullx27\ESI\Models\SovereigntycampaignsParticipants[] $participants Alliance participating and their respective scores, only present in Freeport Events.
     * @return $this
     */
