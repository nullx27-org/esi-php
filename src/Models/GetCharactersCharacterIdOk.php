...
class GetCharactersCharacterIdOk implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['securityStatus']) && ($this->container['securityStatus'] > 10)) {
            $invalid_properties[] = "invalid value for 'securityStatus', must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['securityStatus']) && ($this->container['securityStatus'] < -10)) {
            $invalid_properties[] = "invalid value for 'securityStatus', must be bigger than or equal to -10.";
        }
